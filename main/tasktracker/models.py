...
class Task(models.Model):
    ...
    executor = models.ManyToManyField(User, related_name='tasks_as_executor', blank=True)
    observers = models.ManyToManyField(User, related_name='tasks_as_observer', blank=True)
